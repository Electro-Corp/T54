...
5. Initilize paging and memory managment
6. Select where the root filesystem is (HDD or CDROM)
7. Initilize devices
8. Initilize the filesystem
9. Load /bin/init from that device ("/bin/init? that's a POSIX thing!!")
